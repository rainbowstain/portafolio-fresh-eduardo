...
export default function Home() {
  return (
    <Layout>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 p-2 sm:p-4 min-h-screen max-w-full">
        {/* Header Section - Takes full width */}
        <header class="lg:col-span-12 p-4 sm:p-6 rounded-lg glass-effect flex flex-col md:flex-row justify-between items-center gap-4">
          <div class="text-center md:text-left">
            <h1 class="text-3xl sm:text-4xl font-bold title-animation">
              <span class="text-nothing-white">Eduardo</span> <span class="text-nothing-red">Rojo</span>
            </h1>
            <p class="text-nothing-lightgray text-sm sm:text-base">Ingeniero en Informática | Desarrollador de Software en UltraCropCare</p>
          </div>
          <div class="flex flex-col items-center md:items-end gap-4 w-full md:w-auto">
            <nav class="flex flex-wrap justify-center md:justify-end gap-2 sm:gap-4 text-sm sm:text-base">
              {['SobremIA', 'Habilidades', 'Proyectos', 'Cómo funciona'].map((item, index) => (
                <a 
                  ...
                  class="text-nothing-lightgray hover:text-nothing-white border-b-2 border-transparent hover:border-nothing-red transition-colors duration-300 px-2"
                  key={index}
                >
                  {item}
                </a>
            ...
            <div class="flex gap-3">
              ...
              <a href="https://github.com/rainbowstain" target="_blank" rel="noopener noreferrer" class="text-nothing-lightgray hover:text-nothing-red transition-colors duration-300">
              ...
              <a href="https://linkedin.com/in/eduardo-rojo-serrano" target="_blank" rel="noopener noreferrer" class="text-nothing-lightgray hover:text-nothing-red transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <section id="sobremia" class="lg:col-span-12 p-4 sm:p-6 rounded-lg glass-effect flex flex-col lg:flex-row h-full my-auto border-2 border-nothing-red shadow-lg shadow-nothing-red/20 relative overflow-hidden w-full">
          {/* Fondo decorativo */}
          <div class="absolute inset-0 bg-gradient-to-br from-nothing-black/80 to-nothing-black/60 backdrop-blur-sm"></div>
          
          <div class="lg:w-[25%] flex flex-col items-center justify-start p-2 sm:p-3 border-b lg:border-b-0 lg:border-r border-nothing-gray/30 relative z-10">
            <div class="text-center mb-4 w-full">
              <h3 class="text-nothing-white text-base sm:text-lg font-medium">Portafolios con</h3>
              <h2 class="text-2xl sm:text-3xl font-bold text-nothing-white relative overflow-hidden text-center">
            ...
            <div class="p-3 sm:p-4 border-l-4 border-nothing-red bg-nothing-black bg-opacity-40 w-full backdrop-blur-sm mb-4 relative overflow-hidden">
              <div class="absolute -top-10 -right-10 w-20 h-20 bg-nothing-red opacity-10 rounded-full blur-xl"></div>
              <p class="text-nothing-lightgray text-xs sm:text-sm leading-relaxed">
        ...
        <footer class="lg:col-span-12 p-6 border-t border-nothing-gray text-center text-nothing-lightgray glass-effect rounded-lg mt-8">
          <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <p> 2025 Eduardo Rojo. Por favor, déjame tu feedback en LinkedIn.</p>
